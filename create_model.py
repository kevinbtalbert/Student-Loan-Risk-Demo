...
class CMLModelDeployer:
    ...
    def wait_for_build(self, model_id: str, build_id: str, timeout: int = 600) -> bool:
    ...
    def wait_for_deployment(self, model_id: str, build_id: str, deployment_id: str, timeout: int = 300) -> Optional[str]:
        ...
        while time.time() - start_time < timeout:
            try:
                ...
                if deployment:
                    ...
                    if status == "deployed":
                        endpoint_url = deployment.access_url
    ...
    def deploy_complete_model(self) -> bool:
        ...
        if not self.test_model_endpoint(endpoint_url):
            return False
